...
(function() {
  ...
  angular.module('frontend.core.layout')
    .controller('HeaderController', [
      ...
      function controller(
         ...
         * special case because of 'dashboard.about' state.
         *
        ...
        $scope.isNotActive = function isNotActive(item) {
          return !!(item.state === 'examples' && $state.current.name === 'dashboard.home');
        };
        ...
        $scope.isActive = function isActive(item) {
          ...
          return !!(
            ...
            (item.state === bits[0] && $state.current.name !== 'dashboard.home')
          );
        };
  ...
  angular.module('frontend.core.layout')
    .controller('NavigationController', [
      '$scope', '$state', '$modal',
      '_items', 'UserService', 'AuthService',
      function controller(
        $scope, $state, $modal,
        _items, AuthService, UserService
      ) {
