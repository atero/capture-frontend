...
Checkout the `dashboard/` folder for code and interface dashboard.

``` shell
node dashboard/pizza.js
node dashboard/checkbox.js
# etc...
```
...
See `dashboard/expand.js` for a running example.
