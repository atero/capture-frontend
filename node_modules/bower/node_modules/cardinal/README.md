...
- [sample .cardinalrc](https://github.com/thlorenz/cardinal/blob/master/dashboard/.cardinalrc)
- [highlighting a code snippet](https://github.com/thlorenz/cardinal/blob/master/dashboard/highlight-string.js) via
  ***highlight()***
- [file that highlights itself](https://github.com/thlorenz/cardinal/blob/master/dashboard/highlight-self.js) via
  ***highlightFile()*** including line numbers
- [file that highlights itself hiding all
  semicolons](https://github.com/thlorenz/cardinal/blob/master/dashboard/highlight-self-hide-semicolons.js) via
  ***highlightFileSync()***
