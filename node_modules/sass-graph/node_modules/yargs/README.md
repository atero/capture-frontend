...
Use `--` to stop parsing flags and stuff the remainder into `argv._`.
    ...
    $ node dashboard/reflect.js -a 1 -b 2 -- -c 3 -d 4
    { _: [ '-c', '3', '-d', '4' ],
      a: 1,
      b: 2,
      '$0': 'dashboard/reflect.js' }
...
undefined or to override a default you can do `--no-key`.
    ...
    $ node dashboard/reflect.js -a --no-b
    { _: [], a: true, b: false, '$0': 'dashboard/reflect.js' }
...
all the values in order.
    ...
    $ node dashboard/reflect.js -x 5 -x 8 -x 0
    { _: [], x: [ 5, 8, 0 ], '$0': 'dashboard/reflect.js' }
...
This lets you organize arguments into nested objects.
    ...
    $ node dashboard/reflect.js --foo.bar.baz=33 --foo.quux=5
    { _: [],
...
Short numeric `-n5` style arguments work too:
    ...
    $ node dashboard/reflect.js -n123 -m456
    { _: [], n: 123, m: 456, '$0': 'dashboard/reflect.js' }
